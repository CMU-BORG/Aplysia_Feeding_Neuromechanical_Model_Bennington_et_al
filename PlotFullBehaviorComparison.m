%% ~~~~~~~~~~~~~~~ PLot Full Behavior Comparison ~~~~~~~~~~~~~~~ 
%{
    This script generates Figure 6: Behavioral switching using
    code modified from Webster-Wood et al. 2020. Additional cosmetic
...
files = {'BehaviorSwitching_Output.mat'};

outputfile = 'BehaviorSwitch';
%%
labels = {'Behavior Switching'};
cols = length(labels);
...
data_labels = {"out_behavior_switch"};
...
for j=1:cols
    ...
    data_struct = load([folder,files{j}]).(data_labels{j});
    ...
    idx = grasper_pressure >=0.5; % is grasper closed
